...
public class WinningScreen  extends ApplicationAdapter implements Screen {
    final BaseGame game;
    ...
    public WinningScreen(BaseGame game){
        this.game = game;
        ...
        win = new Texture("labels/win.png");
    ...
    public void render(float delta) {
        ...
        game.batch.draw(win, camera.viewportWidth / 2 + 95, camera.viewportHeight / 2 + 160, 450, 450);
